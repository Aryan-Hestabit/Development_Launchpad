...
## HOW THINK AND ACT
Thought1: I have been asked to read the contents from the poem.txt file. let me first check if the file exists
Act1: list_workspace_files[]
Observe1: Check if the file that is asked exists or not
Thought2: if the files exist, read from the file
Act2: read_from_files[poem.txt]
