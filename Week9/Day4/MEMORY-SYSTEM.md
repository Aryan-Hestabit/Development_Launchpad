...
1. **Semantic Search:** User query $\rightarrow$ FAISS $\rightarrow$ Top 5 relevant facts $\rightarrow$ applied Score Threshold $\rightarrow$ Injected into System Prompt.
