...
async def main():
    user_query = "Should we switch the city bus fleet to Hydrogen or Electric?"
    ...
    print(f"🏗️ Hiring {len(tasks_list)} specialized workers dynamically...")
    worker_agents = []
    execution_tasks = []
    ...
    print("🛡️ Validator is finalizing the report...")
